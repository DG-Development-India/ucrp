...
AddEventHandler('dg:playerLoaded', function(source)
    TriggerClientEvent('dg_MinerJob:loadSpot', source, MiningPos, WashingPos, SmeltingPos)
end)

-- Refresh Spot Status:
RegisterServerEvent('dg_MinerJob:refreshSpots')
AddEventHandler('dg_MinerJob:refreshSpots', function()
    TriggerClientEvent('dg_MinerJob:loadSpot', -1, MiningPos, WashingPos, SmeltingPos)
end)

-- Update Spot Status:
RegisterServerEvent('dg_MinerJob:spotStatus')
AddEventHandler('dg_MinerJob:spotStatus', function(id, status)
    local xPlayer = DGCore.GetPlayerFromId(source)
    if MiningPos[id].pairs ~= nil then
        MiningPos[MiningPos[id].pairs].mining=status
        TriggerClientEvent('dg_MinerJob:updateStatus', -1, MiningPos[id].pairs, status)
    end
    MiningPos[id].mining=status
    TriggerClientEvent('dg_MinerJob:updateStatus', -1, id, status)
end)

-- Server Callback to get inventory pickaxe:
-- DGCore.RegisterServerCallback("dg_MinerJob:getPickaxe",function(source,cb)
-- 	local xPlayer = DGCore.GetPlayerFromId(source)
...
-- Server Callback to get inventory pickaxe:
RegisterNetEvent("dg_MinerJob:getStoneLimit")
AddEventHandler("dg_MinerJob:getStoneLimit",function()
	local xPlayer = DGCore.GetPlayerFromId(source)
	local player = xPlayer.identifier
	table.insert(didmining, {identifier = player})
end)

DGCore.RegisterServerCallback("dg_MinerJob:didmining",function(source, cb) 
local xPlayer = DGCore.GetPlayerFromId(source)
local did = 0
...
-- DGCore.RegisterServerCallback("dg_MinerJob:getWashPan",function(source,cb)
-- 	local xPlayer = DGCore.GetPlayerFromId(source)
...
-- -- Server Callback to get inventory pickaxe:
-- DGCore.RegisterServerCallback("dg_MinerJob:getWashedStoneLimit",function(source,cb)
-- 	local xPlayer = DGCore.GetPlayerFromId(source)
...
-- DGCore.RegisterServerCallback("dg_MinerJob:getWashedStone",function(source,cb)
-- 	local xPlayer = DGCore.GetPlayerFromId(source)
...
-- DGCore.RegisterServerCallback("dg_MinerJob:removeStone",function(source,cb)
-- 	local xPlayer = DGCore.GetPlayerFromId(source)
...
-- RegisterServerEvent("dg_MinerJob:reward")
-- AddEventHandler("dg_MinerJob:reward", function(itemName,itemAmount)
-- 	local xPlayer = DGCore.GetPlayerFromId(source)
...
-- RegisterServerEvent("dg_MinerJob:rewardSmelting")
-- AddEventHandler("dg_MinerJob:rewardSmelting", function()
-- 	local xPlayer = DGCore.GetPlayerFromId(source)
