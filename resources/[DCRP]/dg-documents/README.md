...
<img src="https://i.ibb.co/HtCtSgx/DGCore-documents.png" width="100%">

[![npm version](https://img.shields.io/github/release/apoiat/dg_Documents.svg?style=flat)](https://github.com/apoiat/dg_Deliveries "View this project on npm")  [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)
____
...
## Introduction
Introducing Documents, a great roleplaying addition script for fivem servers using the DGCore framework. <b>This script provides creation, signing, copying and displaying of documents to enrich players' roleplaying experience</b>. Basically you have two type of documents:
* Public documents
...
> <b>Important note:</b>
Make sure your resource folder name is dg_documents. Anything else will make the script malfunction.

### Using Git
```
cd resources
git clone https://github.com/apoiat/dg_Documents [DGCore]/dg_documents
```

### Manually
Download https://github.com/apoiat/dg_Documents/archive/master.zip

Rename folder to dg_documents

Put it in the `[DGCore]` directory

## Installation
Import `dg_documents.sql` in your database
...
Translations and implementation by [DGCore-Brasil]('https://github.com/DGCore-Brasil/')
