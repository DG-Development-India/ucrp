...
local changeYourJob = {
  {name="Job Center", colour=17, id=351, x=-234.5364, y=-920.5567, z=32.31218},
}
...
Citizen.CreateThread(function()
  while true do
    ...
    local jobDst = #(vector3(-234.5364,-920.5567,32.31218) - vector3(plyCoords["x"], plyCoords["y"], plyCoords["z"]))
    ...
    if jobDst > 30 and payDst > 30 then
     ...
     -- DrawMarker(27,-234.5364,-920.5567,32.31218, 0, 0, 0, 0, 0, 0, 0.6, 0.6, 0.5001, 0, 155, 255, 200, 0, 0, 0, 0) 
...
Citizen.CreateThread(function()
		...
		local blip = AddBlipForCoord(vector3(-243.7702,-919.6408,32.31223))
