...
local spawnedVehicles = {
	...
	{ 	cat= 'newmuscle',			model = 'gauntlet3', 		price = 120000,		spawned = true},
	{ 	cat= 'newsuv',				model = 'rebla', 			price = 150000,		spawned = true},
	{ 	cat= 'newsport',			model = 'kanjo', 			price = 50000,		spawned = true},
}
