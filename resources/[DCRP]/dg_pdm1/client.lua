...
local slotsOccupiedBy = {
	...
	{ slot = 12,	cat= 'newmuscle',			model  = 'gauntlet3', 		price = 120000,		spawned = true},
	{ slot = 13,	cat= 'newsuv',				model  = 'rebla', 			price = 150000,		spawned = true},
	{ slot = 14,	cat= 'newsport',			model  = 'kanjo', 			price = 50000,		spawned = true},
}
