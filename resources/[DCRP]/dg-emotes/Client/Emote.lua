...
RegisterNetEvent('dg-emotes:playthisemote')
AddEventHandler('dg-emotes:playthisemote', function(emotename)
	local args = {} 
	args[1] = emotename 
...
function OnEmotePlay(EmoteName)
  ...
  if (IsEntityPlayingAnim(GetPlayerPed(-1), "dead", "dead_a", 3)) then
    return false
  end
