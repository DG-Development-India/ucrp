...
DGCore.RegisterServerCallback("betrayed_garage:obtenerVehiculos", function(source, callback, garage)
...
DGCore.RegisterServerCallback("betrayed_garage:validateVehicle", function(source, callback, vehicleProps, garage)
	local player = DGCore.GetPlayerFromId(source)
...
DGCore.RegisterServerCallback('betrayed_garage:checkMoney', function(source, cb)
