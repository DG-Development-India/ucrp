...
DGCoreRegisterServerCallback("erp_garage:obtenerVehiculos", function(source, callback, garage)
	local player = DGCoreGetPlayerFromId(source)
...
DGCoreRegisterServerCallback("erp_garage:validateVehicle", function(source, callback, vehicleProps, garage)
	local player = DGCoreGetPlayerFromId(source)
...
DGCoreRegisterServerCallback('erp_garage:checkMoney', function(source, cb)
	local xPlayer = DGCoreGetPlayerFromId(source)
	local deudas = 0
...
AddEventHandler('erp_garage:modifystate', function(vehicleProps, state, garage)
	...
	local xPlayer = DGCoreGetPlayerFromId(_source)
...
AddEventHandler("erp_garage:sacarometer", function(vehicle,state,src1)
	...
	local xPlayer = DGCoreGetPlayerFromId(src)
