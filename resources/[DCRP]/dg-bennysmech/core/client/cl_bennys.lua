...
local bennyLocationLSC1 = vector3(-211.7287, -1323.377, 30.89061)
...
local function saveVehicle()
    ...
    TriggerServerEvent('dg-bennysmech:updateVehicle',myCar)  
end
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("dg-bennysmech:attemptPurchase", type, upgradeLevel)
                ...
                if nearbennyLocationLSC1 then
                    if not isPlyInBennys then
                        ...
                        if IsControlJustReleased(1, 38) then
                            if DGCore.GetPlayerData().job.name == 'mechanic' then
...
--#[Event Handlers]#--
RegisterNetEvent("dg-bennysmech:purchaseSuccessful")
AddEventHandler("dg-bennysmech:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("dg-bennysmech:purchaseFailed")
AddEventHandler("dg-bennysmech:purchaseFailed", function()
