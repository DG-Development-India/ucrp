...
-- 	DGCore.UI.Menu.Open('default', GetCurrentResourceName(), 'set_unset_accessory', {
-- 		title = 'PutOn/TakeOff',
-- 		align = 'top-left',
-- 		elements = {
...
-- 				DGCore.TriggerServerCallback('dg-skin:getPlayerSkin', function(skin)
...
-- 	DGCore.TriggerServerCallback('DGCore_accessories:get', function(hasAccessory, accessorySkin)
...
-- 			end)
-- 		else
-- 			DGCore.ShowNotification('no' .. _accessory)
-- 		end
-- 	end, accessory)
-- end
