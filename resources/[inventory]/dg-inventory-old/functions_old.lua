...
AddEventHandler('RunUseItem', function(itemid, slot, inventoryName, isWeapon)
    ...
    if (itemid == "chocolate") then TriggerEvent('food:chocolate') end
    ...
    if (itemid == "meth") then  useItemsDrugs(itemid) end
    ...
    if (itemid == "lockpick") then 
        TriggerEvent('ndrp_carkeys:lockpick')
    end
