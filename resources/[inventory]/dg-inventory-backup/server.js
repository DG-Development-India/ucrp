...
// else if(secondInventory == "123")
// {
//     var targetinvname = targetName;
//     var shopArray = cluckingbellfry();
//     var shopAmount = 5;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "124")
// {
//     var targetinvname = targetName;
//     var shopArray = cluckingbelldrink();
//     var shopAmount = 1;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "125")
// {
//     var targetinvname = targetName;
//     var shopArray = cluckingbelldrink2();
//     var shopAmount = 1;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }
...
// else if(secondInventory == "108")
// {
//     var targetinvname = targetName;
//     var shopArray = pharmacy();
//     var shopAmount = 4;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "109")
// {
//     var targetinvname = targetName;
//     var shopArray = methcraft();
//     var shopAmount = 1;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

else if(secondInventory == "110")
{
    var targetinvname = targetName;
...
// else if(secondInventory == "111")
// {
//     var targetinvname = targetName;
//     var shopArray = jewellerycraft();
//     var shopAmount = 8;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "112")
// {
//     var targetinvname = targetName;
//     var shopArray = cutjewel();
//     var shopAmount = 4;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

else if(secondInventory == "113")
{
    var targetinvname = targetName;
    var shopArray = pdarmoryhigh();
    var shopAmount = 8;
    emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
}

else if(secondInventory == "115")
{
    var targetinvname = targetName;
    var shopArray = pdvending();
    var shopAmount = 6;
    emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
}

// else if(secondInventory == "116")
// {
//     var targetinvname = targetName;
//     var shopArray = getcash();
//     var shopAmount = 1;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

else if(secondInventory == "117")
{
    var targetinvname = targetName;
    var shopArray = policeattachment();
    var shopAmount = 3;
    emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
}

// else if(secondInventory == "119")
// {
//     var targetinvname = targetName;
//     var shopArray = gunclass3barrel();
//     var shopAmount = 5;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "118")
// {
//     var targetinvname = targetName;
//     var shopArray = class3ammo();
//     var shopAmount = 3;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "120")
// {
//     var targetinvname = targetName;
//     var shopArray = class1gun();
//     var shopAmount = 5;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "121")
// {
//     var targetinvname = targetName;
//     var shopArray = class1guncomp();
//     var shopAmount = 20;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }

// else if(secondInventory == "122")
// {
//     var targetinvname = targetName;
//     var shopArray = class1ammo();
//     var shopAmount = 2;
//     emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
// }
...
function PoliceArmory() {
    var shopItems = [
        { item_id: "-771403250", id: 0, name: "Shop", information: "{}", slot: 1, amount: 1 },//pd pistol
        { item_id: "736523883", id: 0, name: "Shop", information: "{}", slot: 2, amount: 1 },//pd smg
        { item_id: "911657153", id: 0, name: "Shop", information: "{}", slot: 3, amount: 1 },// stun gun
        { item_id: "1737195953", id: 0, name: "Shop", information: "{}", slot: 4, amount: 1 },//night stick
        { item_id: "2343591895", id: 0, name: "Shop", information: "{}", slot: 5, amount: 1 },//flash light
        { item_id: "-1075685676", id: 0, name: "Shop", information: "{}", slot: 6, amount: 1 },//Ap Pistol
        { item_id: "pistolammo", id: 0, name: "Shop", information: "{}", slot: 7, amount: 5 },
        { item_id: "subammo", id: 0, name: "Shop", information: "{}", slot: 8, amount: 5 },
        { item_id: "cuffs", id: 0, name: "Shop", information: "{}", slot: 9, amount: 5 },
        { item_id: "armor", id: 0, name: "Shop", information: "{}", slot: 10, amount: 10 },
        { item_id: "watch", id: 0, name: "Shop", information: "{}", slot: 11, amount: 1 },
        { item_id: "IFAK", id: 0, name: "Shop", information: "{}", slot: 12, amount: 10 },
        { item_id: "radio", id: 0, name: "Shop", information: "{}", slot: 13, amount: 1 },
        { item_id: "-72657034", id: 0, name: "Shop", information: "{}", slot: 14, amount: 5 },
        { item_id: "oxygentank", id: 0, name: "Shop", information: "{}", slot: 15, amount: 5 },
...
function MedicArmory() {
    var shopItems = [
        ...
        { item_id: "cigar", id: 0, name: "Shop", information: "{}", slot: 6, amount: 50 },
    ];
    return JSON.stringify(shopItems);
}
...
function MedicArmoryCiv() {
    var shopItems = [
        { item_id: "bloodbag", id: 0, name: "Shop", information: "{}", slot: 1, amount: 1 },
        { item_id: "bloodvial", id: 0, name: "Shop", information: "{}", slot: 2, amount: 1 }, 
        { item_id: "paracetamol", id: 0, name: "Shop", information: "{}", slot: 3, amount: 1 },  
        { item_id: "pand", id: 0, name: "Shop", information: "{}", slot: 4, amount: 1 },
        { item_id: "aspirin", id: 0, name: "Shop", information: "{}", slot: 5, amount: 1 },
        { item_id: "chloroform", id: 0, name: "Shop", information: "{}", slot: 6, amount: 1 },
        { item_id: "ibuprofen", id: 0, name: "Shop", information: "{}", slot: 7, amount: 1 },
        { item_id: "armxray", id: 0, name: "Shop", information: "{}", slot: 8, amount: 1 },
        { item_id: "chestxray", id: 0, name: "Shop", information: "{}", slot: 9, amount: 1 },
        { item_id: "sbsxray", id: 0, name: "Shop", information: "{}", slot: 10, amount: 1 }, 
    ];
    return JSON.stringify(shopItems);
}
...
//         { item_id: "dopamine", id: 0, name: "Shop", information: "{}", slot: 2, amount: 50 },
//         { item_id: "paracetamol", id: 0, name: "Shop", information: "{}", slot: 3, amount: 50 },
//         { item_id: "pand", id: 0, name: "Shop", information: "{}", slot: 4, amount: 50 },
//     ];
//     return JSON.stringify(shopItems);
// }
...
// function gunclass3() {
//     var shopItems = [
//         { item_id: "3173288789", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },// Skorpion
//         { item_id: "324215364", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },//micro smg mk2
//         { item_id: "1627465347", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },//Gusenberg Mk2
//         { item_id: "1649403952", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },//Cmp Rifle Mk2
//         { item_id: "-1074790547", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },//AR Mk2
//         //{ item_id: "subammo", id: 0, name: "craft", information: "{}", slot: 5, amount: 5 },
//         //{ item_id: "extended_micro", id: 0, name: "craft", information: "{}", slot: 6, amount: 1 },
//         //{ item_id: "silencer_s", id: 0, name: "craft", information: "{}", slot: 7, amount: 1 },
//         //{ item_id: "extended_tec9", id: 0, name: "craft", information: "{}", slot: 8, amount: 1 },
...
// function class3comp() {
//     var shopItems = [
//           { item_id: "skbody", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//           { item_id: "skmag", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//           { item_id: "msbody", id: 0, name: "craft", information: "{}", slot: 3, amount: 50 },
//           { item_id: "msmag", id: 0, name: "craft", information: "{}", slot: 4, amount: 50 },
//           { item_id: "gbbody", id: 0, name: "craft", information: "{}", slot: 5, amount: 50 },
//           { item_id: "gbmag", id: 0, name: "craft", information: "{}", slot: 6, amount: 50 },
//           { item_id: "arbody", id: 0, name: "craft", information: "{}", slot: 7, amount: 50 },
//           { item_id: "armag", id: 0, name: "craft", information: "{}", slot: 8, amount: 50 },
//           { item_id: "crbody", id: 0, name: "craft", information: "{}", slot: 9, amount: 50 },
//           { item_id: "crmag", id: 0, name: "craft", information: "{}", slot: 10, amount: 50 },
//     ];
//     return JSON.stringify(shopItems);
// }

// function class3spring() {
//     var shopItems = [
//           { item_id: "skspring", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//           { item_id: "msspring", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//           { item_id: "gbspring", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
//           { item_id: "arspring", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },
//           { item_id: "crspring", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }

// function gunclass3barrel() {
//     var shopItems = [
//           { item_id: "skbarrel", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//           { item_id: "msbarrel", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//           { item_id: "gbbarrel", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
//           { item_id: "arbarrel", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },
//           { item_id: "crbarrel", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }
...
// function class3ammo() {
//     var shopItems = [
//           { item_id: "subammo", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//           { item_id: "rifleammo", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//           { item_id: "heavyammo", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }
...
//           { item_id: "1593441988", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//           { item_id: "-1746263880", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
//           { item_id: "2017895192", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },
//           { item_id: "4019527611", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }

// function class1guncomp() {
//     var shopItems = [
//           { item_id: "hbody", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//           { item_id: "hbarrel", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//           { item_id: "hmag", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
//           { item_id: "hspring", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },
//           { item_id: "cbody", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },
//           { item_id: "cbarrel", id: 0, name: "craft", information: "{}", slot: 6, amount: 1 },
//           { item_id: "cmag", id: 0, name: "craft", information: "{}", slot: 7, amount: 1 },
//           { item_id: "cspring", id: 0, name: "craft", information: "{}", slot: 8, amount: 1 },
//           { item_id: "cmbody", id: 0, name: "craft", information: "{}", slot: 9, amount: 1 },
//           { item_id: "cmbarrel", id: 0, name: "craft", information: "{}", slot: 10, amount: 1 },
//           { item_id: "cmmag", id: 0, name: "craft", information: "{}", slot: 11, amount: 1 },
//           { item_id: "cmspring", id: 0, name: "craft", information: "{}", slot: 12, amount: 1 },
//           { item_id: "dbbody", id: 0, name: "craft", information: "{}", slot: 13, amount: 1 },
//           { item_id: "dbbarrel", id: 0, name: "craft", information: "{}", slot: 14, amount: 1 },
//           { item_id: "dbmag", id: 0, name: "craft", information: "{}", slot: 15, amount: 1 },
//           { item_id: "dbspring", id: 0, name: "craft", information: "{}", slot: 16, amount: 1 },
//           { item_id: "swbody", id: 0, name: "craft", information: "{}", slot: 17, amount: 1 },
//           { item_id: "swbarrel", id: 0, name: "craft", information: "{}", slot: 18, amount: 1 },
//           { item_id: "swmag", id: 0, name: "craft", information: "{}", slot: 19, amount: 1 },
//           { item_id: "swspring", id: 0, name: "craft", information: "{}", slot: 20, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }
...
// function class1ammo() {
//     var shopItems = [
//           { item_id: "pistolammo", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//           { item_id: "shotgunammo", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }
...
//  function Smelting() {
//      var shopItems = [
//         { item_id: "gold", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//         { item_id: "silver", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//         { item_id: "copper", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
//         { item_id: "aluminium", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },
//         { item_id: "iron", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },
//      ];
//      return JSON.stringify(shopItems);
//  }
...
// function cluckingbellfry() {
//     var shopItems = [
//         { item_id: "chickenpop", id: 0, name: "craft", information: "{}", slot: 1, amount: 1 },
//         { item_id: "chickenwing", id: 0, name: "craft", information: "{}", slot: 2, amount: 1 },
//         { item_id: "chickenleg", id: 0, name: "craft", information: "{}", slot: 3, amount: 1 },
//         { item_id: "frenchfry", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },
//         { item_id: "onionring", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }
...
//         { item_id: "cbfarmers", id: 0, name: "craft", information: "{}", slot: 4, amount: 1 },
//         { item_id: "cbfries", id: 0, name: "craft", information: "{}", slot: 5, amount: 1 },
//         { item_id: "cbrings", id: 0, name: "craft", information: "{}", slot: 6, amount: 1 },
//         { item_id: "cbrownie", id: 0, name: "craft", information: "{}", slot: 7, amount: 1 },
//         { item_id: "cbveggy", id: 0, name: "craft", information: "{}", slot: 8, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }

// function cluckingbelldrink() {
//     var shopItems = [
//         { item_id: "cbdrink", id: 0, name: "Shop", information: "{}", slot: 1, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }

// function cluckingbelldrink2() {
//     var shopItems = [
//         { item_id: "cola", id: 0, name: "Shop", information: "{}", slot: 1, amount: 5 },
//     ];
//     return JSON.stringify(shopItems);
// }
...
function ConvenienceStore() {
    var shopItems = [
        ...
        { item_id: "donut", id: 0, name: "Shop", information: "{}", slot: 3, amount: 10 },
        { item_id: "lighter", id: 0, name: "Shop", information: "{}", slot: 4, amount: 10},
        { item_id: "water", id: 0, name: "Shop", information: "{}", slot: 5, amount: 10 },
        { item_id: "bandage", id: 0, name: "Shop", information: "{}", slot: 6, amount: 10},
        { item_id: "firstaidkit", id: 0, name: "Shop", information: "{}", slot: 7, amount: 10},
        { item_id: "ciggy", id: 0, name: "Shop", information: "{}", slot: 8, amount: 10 },
        { item_id: "mobilephone", id: 0, name: "Shop", information: "{}", slot: 9, amount: 10 },
        { item_id: "cigar", id: 0, name: "Shop", information: "{}", slot: 10, amount: 10 },
    ];
    return JSON.stringify(shopItems);
}
...
function HardwareStore() {
    var shopItems = [
        { item_id: "oxygentank", id: 0, name: "Shop", information: "{}", slot: 1, amount: 5 },
        { item_id: "bulletproof", id: 0, name: "Shop", information: "{}", slot: 2, amount: 5 },
        { item_id: "parachute", id: 0, name: "Shop", information: "{}", slot: 3, amount: 5 },
        ...
        { item_id: "fishingrod", id: 0, name: "Shop", information: "{}", slot: 10, amount: 5}, 
        { item_id: "pickaxe", id: 0, name: "Shop", information: "{}", slot: 11, amount: 5},  
        { item_id: "axe", id: 0, name: "Shop", information: "{}", slot: 12, amount: 5},
        { item_id: "lockpick", id: 0, name: "Shop", information: "{}", slot: 13, amount: 5},
        { item_id: "advlockpick", id: 0, name: "Shop", information: "{}", slot: 14, amount: 5},
        { item_id: "repairkit", id: 0, name: "Shop", information: "{}", slot: 15, amount: 5},   
    ];
    return JSON.stringify(shopItems);
}
...
//         { item_id: "coldcoffee", id: 0, name: "Shop", information: "{}", slot: 2, amount: 5 },
//         { item_id: "cappuccino", id: 0, name: "Shop", information: "{}", slot: 3, amount: 5 },
//         { item_id: "mshake", id: 0, name: "Craft", information: "{}", slot: 4, amount: 5 },
//         { item_id: "cookies", id: 0, name: "Craft", information: "{}", slot: 5, amount: 5 },
//         { item_id: "muffins", id: 0, name: "Craft", information: "{}", slot: 6, amount: 5 },
//         { item_id: "pestry", id: 0, name: "Craft", information: "{}", slot: 7, amount: 5 },
...
// function methcraft() {
//     var shopItems = [
//         { item_id: "1gcrack", id: 0, name: "Craft", information: "{}", slot: 1, amount: 5 },
//     ];
//     return JSON.stringify(shopItems);
// };
...
function blackmarket() {
    var shopItems = [
        { item_id: "cuffs", id: 0, name: "Shop", information: "{to cuff}", slot: 1, amount: 5 },
        { item_id: "advlockpick", id: 0, name: "Shop", information: "{to unlock a door}", slot: 2, amount: 5 },
        { item_id: "lockpick", id: 0, name: "Shop", information: "{to unlock a cardoor}", slot: 3, amount: 5 },
        { item_id: "locksystem", id: 0, name: "Shop", information: "{find it}", slot: 4, amount: 5 },
    ];
    return JSON.stringify(shopItems);
};
...
// function Workshop() {
//     var shopItems = [
//         { item_id: "coffee", id: 0, name: "Shop", information: "{}", slot: 1, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// };

// function jewellerycraft() {
//     var shopItems = [
//         { item_id: "diamondneck", id: 0, name: "Craft", information: "{}", slot: 1, amount: 1 },
//         { item_id: "ering", id: 0, name: "Craft", information: "{}", slot: 2, amount: 1 },
//         { item_id: "erpring", id: 0, name: "Craft", information: "{}", slot: 3, amount: 1 },
//         { item_id: "wedding", id: 0, name: "Craft", information: "{}", slot: 4, amount: 1 },
//         { item_id: "diamondering", id: 0, name: "Craft", information: "{}", slot: 5, amount: 1 },
//         { item_id: "bluering", id: 0, name: "Craft", information: "{}", slot: 6, amount: 1 },
//         { item_id: "yellowring", id: 0, name: "Craft", information: "{}", slot: 7, amount: 1 },
//         { item_id: "rubyring", id: 0, name: "Craft", information: "{}", slot: 8, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// };
...
// function cutjewel() {
//     var shopItems = [
//         { item_id: "diamond", id: 0, name: "Craft", information: "{}", slot: 1, amount: 1 },
//         { item_id: "bdiamond", id: 0, name: "Craft", information: "{}", slot: 2, amount: 1 },
//         { item_id: "ydiamond", id: 0, name: "Craft", information: "{}", slot: 3, amount: 1 },
//         { item_id: "ruby", id: 0, name: "Craft", information: "{}", slot: 4, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// };

function pdarmoryhigh() {
    var shopItems = [
        { item_id: "-1357824103", id: 0, name: "Shop", information: "{}", slot: 1, amount: 1 },//Adv Rifle Mk2
        { item_id: "2132975508", id: 0, name: "Shop", information: "{}", slot: 2, amount: 1 },//Bullpop Rifle
        { item_id: "-2084633992", id: 0, name: "Shop", information: "{}", slot: 3, amount: 1 },//pd 556
        { item_id: "1432025498", id: 0, name: "Shop", information: "{}", slot: 4, amount: 1 },//PD shotgun
        { item_id: "584646201", id: 0, name: "Shop", information: "{}", slot: 5, amount: 1 },//Ap Pistol
        { item_id: "pistolammo", id: 0, name: "Shop", information: "{}", slot: 6, amount: 5 },
        { item_id: "rifleammo", id: 0, name: "Shop", information: "{}", slot: 7, amount: 5 },
        { item_id: "shotgunammo", id: 0, name: "Shop", information: "{}", slot: 8, amount: 10 },
    ];
    return JSON.stringify(shopItems);
};

function policeattachment() {
    var shopItems = [
        { item_id: "silencer_l", id: 0, name: "Shop", information: "{}", slot: 1, amount: 1 },
        { item_id: "TinyScope", id: 0, name: "Shop", information: "{}", slot: 2, amount: 1 },
        { item_id: "flash", id: 0, name: "Shop", information: "{}", slot: 3, amount: 1 },
    ];
    return JSON.stringify(shopItems);
}
...
// function getcash() {
//     var shopItems = [
//         { item_id: "rollcash", id: 0, name: "Craft", information: "{}", slot: 1, amount: 1 },
//     ];
//     return JSON.stringify(shopItems);
// }