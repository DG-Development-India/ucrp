...
AddEventHandler('RunUseItem', function(itemid, slot, inventoryName, isWeapon)
    ...
    if (itemid == "mcpaneerwrap") then
        TriggerEvent("inventory:removeItem",'mcpaneerwrap', 1)
        TriggerEvent('food:mcpaneerwrap')
    end
    if (itemid == "mcsignaturewrap") then
        TriggerEvent("inventory:removeItem",'mcsignaturewrap', 1)
        TriggerEvent('food:mcsignaturewrap')
    end
    if (itemid == "mcnugget") then
        TriggerEvent("inventory:removeItem",'mcnugget', 1)
        TriggerEvent('food:mcnugget')
    end
    if (itemid == "mcchicken") then
        TriggerEvent("inventory:removeItem",'mcchicken', 1)
        TriggerEvent('food:mcchicken')
    end
    if (itemid == "mcchickenwrap") then
        TriggerEvent("inventory:removeItem",'mcchickenwrap', 1)
        TriggerEvent('food:mcchickenwrap')
    end
    if (itemid == "mcmaharaja") then
        TriggerEvent("inventory:removeItem",'mcmaharaja', 1)
        TriggerEvent('food:mcmaharaja')
    end
    if (itemid == "mcchocolatefrappe") then
        TriggerEvent("inventory:removeItem",'mcchocolatefrappe', 1)
        TriggerEvent('food:mcchocolatefrappe')
    end
    if (itemid == "mcdietcoke") then
        TriggerEvent("inventory:removeItem",'mcdietcoke', 1)
        TriggerEvent('food:mcdietcoke')
    end
    if (itemid == "mcfanta") then
        TriggerEvent("inventory:removeItem",'mcfanta', 1)
        TriggerEvent('food:mcfanta')
    end
    if (itemid == "mealbox1") then
        TriggerEvent('food:mealbox1')
    end
    if (itemid == "mealbox2") then
        TriggerEvent('food:mealbox2')
    end    
