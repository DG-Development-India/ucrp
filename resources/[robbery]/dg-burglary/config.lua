...
config.LootTable = {
  { name = 'water', label = 'Water' , prob = 'common' , type = 'Fridge' , quantity = math.random(1,2)},
  { name = 'pchicken', label = 'Packaged Chicken' , prob = 'rare' , type = 'Fridge' , quantity = math.random(1,4)},
  { name = 'hamburger', label = 'Hamburger' , prob = 'common' , type = 'Fridge' , quantity = math.random(1,2)},
  { name = 'beer', label = 'beer' , prob = 'common' , type = 'Fridge' , quantity = math.random(1,2)},
  { name = 'cola', label = 'cola' , prob = 'common' , type = 'Fridge' , quantity = math.random(1,2)},
  { name = 'coffee', label = 'coffee' , prob = 'common' , type = 'Fridge' , quantity = math.random(1,2)},
  
  { name = 'stolencasiowatch', label = 'Casio Watch (p)' , prob = 'common' , type = 'Drawers' , quantity = 1},  
  { name = 'stolengameboy', label = 'Gameboy (p)' , prob = 'common' , type = 'Drawers' , quantity = 1},  
  { name = 'stoleniphone', label = 'Apple Iphone (p)' , prob = 'rare' , type = 'Drawers' , quantity = 1},  
  { name = 'stolennokia', label = 'Nokia Phone (p)' , prob = 'rare' , type = 'Drawers' , quantity = 1},
  { name = 'stolenpixel3', label = 'Pixel 3 Phone (p)' , prob = 'rare' , type = 'Drawers' , quantity = 1},
  { name = 'rolexwatch', label = 'Rolex Watch (p)' , prob = 'super' , type = 'Drawers' , quantity = 1},
  { name = 'stolenpsp', label = 'PSP (p)' , prob = 'rare' , type = 'Drawers' , quantity = 1},
  { name = 'stolens8', label = 'Samsung S8 (p)' , prob = 'rare' , type = 'Drawers' , quantity = 1},
  { name = 'decryptred', label = 'Red Decrypter' , prob = 'rare' , type = 'Drawers' , quantity = 1},
  { name = 'decryptyellow', label = 'Yellow Decrypter' , prob = 'common' , type = 'Drawers' , quantity = 1},
  { name = 'decryptblue', label = 'Blue Decrypter' , prob = 'super' , type = 'Drawers' , quantity = 1},
  
  { name = 'stolenoakleys', label = 'Oakley Sunglasses (p)' , prob = 'common' , type = 'Table' , quantity = 1},
  { name = 'stolenraybans', label = 'Ray Ban Sunglasses (p)' , prob = 'common' , type = 'Table' , quantity = 1},
  { name = 'plastic', label = 'plastic' , prob = 'common' , type = 'Table' , quantity = math.random(1,5)},
  { name = 'rubber', label = 'rubber' , prob = 'common' , type = 'Table' , quantity = math.random(1,5)},
  { name = 'maneki', label = 'Maneki Neko' , prob = 'common' , type = 'Table' , quantity = 1},
  { name = 'action', label = 'Action Figure' , prob = 'common' , type = 'Table' , quantity = 1},
  -- { name = 'decryptred', label = 'Red Decrypter' , prob = 'rare' , type = 'Table' , quantity = 1},
  -- { name = 'decryptyellow', label = 'Yellow Decrypter' , prob = 'common' , type = 'Table' , quantity = 1},
  -- { name = 'decryptblue', label = 'Blue Decrypter' , prob = 'super' , type = 'Table' , quantity = 1},
  
  
  { name = 'joint', label = 'joint' , prob = 'common' , type = 'Storage' , quantity = math.random(1,5)},
  { name = 'agothic', label = 'American Gothic' , prob = 'rare' , type = 'Storage' , quantity = 1},
  { name = 'anime', label = 'Anime Poster' , prob = 'common' , type = 'Storage' , quantity = 1},
  { name = 'camille', label = 'Camille' , prob = 'rare' , type = 'Storage' , quantity = 1},
  { name = 'csuey', label = 'csuey' , prob = 'common' , type = 'Storage' , quantity = 1},
  { name = 'csuey', label = 'csuey' , prob = 'common' , type = 'Storage' , quantity = 1},  

  
  { name = 'doramaar', label = 'Dora Maar au Chat' , prob = 'rare' , type = 'Wardrobe' , quantity = 1},  
  { name = 'femmes', label = 'Les Femmes d\'Alger' , prob = 'rare' , type = 'Wardrobe' , quantity = 1},    
  { name = 'gachet', label = 'Portrait of Dr.Gachet' , prob = 'common' , type = 'Wardrobe' , quantity = 1},  
  { name = 'salvator', label = 'Salvator Mundi' , prob = 'rare' , type = 'Wardrobe' , quantity = 1},  
  { name = 'scream', label = 'The Scream' , prob = 'common' , type = 'Wardrobe' , quantity = 1},
  -- { name = 'decryptred', label = 'Red Decrypter' , prob = 'rare' , type = 'Wardrobe' , quantity = 1},
  -- { name = 'decryptyellow', label = 'Yellow Decrypter' , prob = 'common' , type = 'Wardrobe' , quantity = 1},
  -- { name = 'decryptblue', label = 'Blue Decrypter' , prob = 'super' , type = 'Wardrobe' , quantity = 1},
  
  { name = 'jadeite', label = 'Jadeite Stone' , prob = 'common' , type = 'Jewelry' , quantity = 1},  
  { name = 'stolen2ctchain', label = '2ct Gold Chain (p)' , prob = 'common' , type = 'Jewelry' , quantity = 1},  
  { name = 'stolen5ctchain', label = '5ct Gold Chain (p)' , prob = 'rare' , type = 'Jewelry' , quantity = 1},  
  { name = 'stolen8ctchain', label = '8ct Gold Chain (p)' , prob = 'rare' , type = 'Jewelry' , quantity = 1},  
  { name = 'stolen10ctchain', label = '10ct Gold Chain (p)' , prob = 'rare' , type = 'Jewelry' , quantity = 1},  
  { name = 'dskull', label = 'Diamond Skull' , prob = 'super' , type = 'Jewelry' , quantity = 1},   
  
  { name = 'sgrace', label = 'Saying Grace' , prob = 'rare' , type = 'Under Bed' , quantity = 1}, 
  { name = 'starrynight', label = 'Starry Night' , prob = 'common' , type = 'Under Bed' , quantity = 1}, 
  { name = 'telvis', label = 'Triple Elvis' , prob = 'rare' , type = 'Under Bed' , quantity = 1}, 
  { name = 'weeping', label = 'Weeping Woman' , prob = 'common' , type = 'Under Bed' , quantity = 1}, 
  { name = 'wlilies', label = 'Water Lilies' , prob = 'common' , type = 'Under Bed' , quantity = 1},

  
  { name = 'zebra', label = 'Zebra' , prob = 'common' , type = 'Cupboards' , quantity = 1}, 
  { name = 'monalisa', label = 'Mona Lisa' , prob = 'rare' , type = 'Cupboards' , quantity = 1}, 
  { name = 'antlers', label = 'Antlers' , prob = 'rare' , type = 'Cupboards' , quantity = 1}, 
  { name = 'mfalcon', label = 'Maltese Falcon' , prob = 'common' , type = 'Cupboards' , quantity = 1}, 
  { name = 'marstonrevolver', label = 'John Marston\'s Cattleman Revolver' , prob = 'super' , type = 'Cupboards' , quantity = 1},
  { name = 'decryptred', label = 'Red Decrypter' , prob = 'rare' , type = 'Cupboards' , quantity = 1},
  { name = 'decryptyellow', label = 'Yellow Decrypter' , prob = 'common' , type = 'Cupboards' , quantity = 1},
  { name = 'decryptblue', label = 'Blue Decrypter' , prob = 'super' , type = 'Cupboards' , quantity = 1},
  
  { name = 'wallet', label = 'Wallet' , prob = 'super' , type = 'Cabinet' , quantity = 1}, 
  { name = 'dragon', label = 'Dragon' , prob = 'super' , type = 'Cabinet' , quantity = 1}, 
  { name = 'stoleniphone', label = 'Apple Iphone (p)' , prob = 'rare' , type = 'Cabinet' , quantity = 1}, 
  { name = 'stolennokia', label = 'Nokia Phone (p)' , prob = 'common' , type = 'Cabinet' , quantity = 1}, 
  { name = 'mfalcon', label = 'Maltese Falcon' , prob = 'common' , type = 'Cabinet' , quantity = 1},
  { name = 'decryptred', label = 'Red Decrypter' , prob = 'rare' , type = 'Cabinet' , quantity = 1},
  { name = 'decryptyellow', label = 'Yellow Decrypter' , prob = 'common' , type = 'Cabinet' , quantity = 1},
  { name = 'decryptblue', label = 'Blue Decrypter' , prob = 'super' , type = 'Cabinet' , quantity = 1},
  
  { name = 'joint', label = 'joint' , prob = 'super' , type = 'Coffee Table' , quantity = math.random(1,4)}, 
  { name = 'beer', label = 'beer' , prob = 'common' , type = 'Coffee Table' , quantity = math.random(1,2)},
  { name = 'Gruppe6Card', label = 'G6 C Card' , prob = 'super' , type = 'Coffee Table' , quantity = 1}, 
  { name = 'Gruppe6Card2', label = 'G6 HS Card' , prob = 'super' , type = 'Coffee Table' , quantity = 1}, 
  { name = 'Gruppe6Card22', label = 'G6 V Card' , prob = 'super' , type = 'Coffee Table' , quantity = 1},
  { name = 'Gruppe6Card3', label = 'G6 P Card' , prob = 'super' , type = 'Coffee Table' , quantity = 1}
