local DGCore, selectedspawnposition = nil
...
AddEventHandler('hotel:createRoom', function(numMultiplier,roomType,mykeys,illness,isImprisoned,isClothesSpawn)
	...
	selectedspawnposition = DGCore.GetPlayerData()["lastPosition"]
	...
	myspawnpoints  = {
		...
		[3] =  { ['x'] = 453.29,['y'] = -662.23,['z'] = 28.01,['h'] = 5.73, ['info'] = ' LS Bus Station', ["typeSpawn"] = 1 },
		[4] =  { ['x'] = 272.16,['y'] = 185.44,['z'] = 104.67,['h'] = 320.57, ['info'] = ' Vinewood Blvd Taxi Stand', ["typeSpawn"] = 1 },
		[5] =  { ['x'] = 1955.54,['y'] = 3843.48,['z'] = 32.0165,['h'] = 282.91, ['info'] = ' Sandy Shores ', ["typeSpawn"] = 1 },
...
function confirmSpawning(isClothesSpawn)
	...
	local xPlayer = DGCore.GetPlayerData()
