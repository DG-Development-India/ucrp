...
Citizen.CreateThread(function()
    while true do
        ...
        if NetworkIsSessionStarted() then
			...
			TriggerServerEvent("dg-scoreboard:AddPlayer")
			TriggerServerEvent('dg-admin:AddPlayer')
...
RegisterNetEvent('dg-login:swapcharacter')
AddEventHandler('dg-login:swapcharacter', function()
	TriggerEvent("kashactersC:WelcomePage")
...
local function disconnect()
    TriggerServerEvent("dg-login:disconnectPlayer")
end
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
	...
	if isnew then
		...
		TriggerEvent('dg-identity:showRegisterIdentity')
		...
		TriggerServerEvent("dg-clothing:get_character_current")
