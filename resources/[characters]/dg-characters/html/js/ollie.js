...
$('.create-button').click(function () {
    ...
    $.post("http://dg-characters/CharacterChosen", JSON.stringify({
...
$("#deletechar").click(function () {
	...
	if (chosenCharacterId > 0) {
		$.post("http://dg-characters/DeleteCharacter", JSON.stringify({
			charid: Number(chosenCharacterId),
		}));
    }
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://dg-characters/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
...
function disconnect(){
    $.post("http://dg-characters/DisconnectGame", JSON.stringify({
    }));
