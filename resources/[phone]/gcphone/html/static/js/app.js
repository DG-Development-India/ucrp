                        ...
                        if (
                            (null !== this.appelsInfo && !0 !== this.appelsInfo.is_accepts
                                ? (null !== this.soundCall && this.soundCall.pause(),
                                  !0 === this.appelsInfo.initiator ? (this.soundCall = new Audio("/html/static/sound/Phone_Call_Sound_Effect.ogg")) : (this.soundCall = new Audio("/html/static/sound/" + this.sonido.value)),
                ...
                methods: {
                    onSelect: function (t) {
                        ...
                        !0 !== this.ignoreControls &&
                            ...
                            l.a.CreateModal({ choix: [].concat(o()(t.subMenu), [{ title: "Cancelar" }]) }).then(function (t) {
                                                ...
                                                case 0:
                                                    (s = e.value),
                                                        "URL" === s
                                                            ? ((n.ignoreControls = !0),
                                                              d.a
                                                                  .CreateTextModal({ text: "https://merriam-webster.com/assets/mw/images/article/art-wap-article-main/egg-3442-e1f6463624338504cd021bf23aef8441@1x.jpg	" })
                                                                  .then(function (t) {
                                                                      "" !== t.text && void 0 !== t.text && null !== t.text && "https://merriam-webster.com/assets/mw/images/article/art-wap-article-main/egg-3442-e1f6463624338504cd021bf23aef8441@1x.jpg	" !== t.text && n.setBackground({ label: "Custom", value: t.text });
                                                                  })
                                                                  .finally(function () {
                                                                      n.ignoreControls = !1;
                                                                  }))
