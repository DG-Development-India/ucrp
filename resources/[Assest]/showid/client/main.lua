    ...
    while true do
        ...
        if animationState ~= shouldDraw then
            ...
            if animationState then
                ...
                DGCore.Streaming.RequestAnimDict('missheistdockssetup1clipboard@base', function()
...
function GetNeareastPlayers()
    ...
    local players, _ = DGCore.Game.GetPlayersInArea(GetEntityCoords(playerPed), Config.DrawDistance)
