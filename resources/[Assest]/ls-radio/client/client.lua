...
function enableRadio(enable)
  ...
  TriggerEvent("ndrp_emotes:playthisemote",'radio')
...
--[[RegisterCommand('radiotest', function(source, args)
  ...
  local data = exports.dg_voip:getPlayerData(playerName, "radio:channel")
...
RegisterNUICallback('joinRadio', function(data, cb)
    ...
    local PlayerData = DGCore.GetPlayerData(_source)
    local playerName = GetPlayerName(PlayerId())
    local getPlayerRadioChannel = exports.dg_voip:getPlayerData(playerName, "radio:channel")

    if tonumber(data.channel) ~= tonumber(getPlayerRadioChannel) then
        if tonumber(data.channel) <= Config.RestrictedChannels then
          if(PlayerData.job.name == 'police' or PlayerData.job.name == 'ems' or PlayerData.job.name == 'mechanic') then
            exports.dg_voip:removePlayerFromRadio(getPlayerRadioChannel)
            exports.dg_voip:setPlayerData(playerName, "radio:channel", tonumber(data.channel), true);
            exports.dg_voip:addPlayerToRadio(tonumber(data.channel))
            exports['mythic_notify']:SendAlert('inform', Config.messages['joined_to_radio'] .. data.channel .. ' MHz </b>')
          elseif not (PlayerData.job.name == 'police' or PlayerData.job.name == 'ems' or PlayerData.job.name == 'mechanic') then
   ...
   local getPlayerRadioChannel = exports.dg_voip:getPlayerData(playerName, "radio:channel")
    ...
    if getPlayerRadioChannel == "nil" then
      exports['mythic_notify']:SendAlert('inform', Config.messages['not_on_radio'])
          ...
          exports.dg_voip:removePlayerFromRadio(getPlayerRadioChannel)
          exports.dg_voip:setPlayerData(playerName, "radio:channel", "nil", true)
...
AddEventHandler('ls-radio:onRadioDrop', function(source)
  ...
  if getPlayerRadioChannel ~= "nil" then
    ...
    exports.dg_voip:removePlayerFromRadio(getPlayerRadioChannel)
    exports.dg_voip:setPlayerData(playerName, "radio:channel", "nil", true)
    exports['ls_notify']:SendAlert('inform', Config.messages['you_leave'] .. getPlayerRadioChannel .. ' MHz </b>')
