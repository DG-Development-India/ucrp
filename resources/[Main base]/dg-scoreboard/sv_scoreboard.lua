...
RegisterServerEvent('dg-scoreboard:AddPlayer')
AddEventHandler("dg-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("dg-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("dg-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("dg-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("dg-scoreboard:RemoveRecent", -1, plyid)
end)
