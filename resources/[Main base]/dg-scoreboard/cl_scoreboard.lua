...
RegisterNetEvent("dg-scoreboard:RemovePlayer")
AddEventHandler("dg-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("dg-scoreboard:AddPlayer")
AddEventHandler("dg-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("dg-scoreboard:RemoveRecent")
AddEventHandler("dg-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("dg-scoreboard:AddAllPlayers")
AddEventHandler("dg-scoreboard:AddAllPlayers", function(data)
                    ...
                    if ped == playerped then
                       -- DrawText3DTalking(playerCoords.x, playerCoords.y, playerCoords.z+0.5, " ".. GetPlayerServerId(id) .. " ", {152, 251, 152, 255})
                        ...
                        if (distance < disPlayerNames) then
                            if exports.dg_voip:getPlayerData(GetPlayerServerId(id), 'voip:talking') == 1 then
                                if cansee then
