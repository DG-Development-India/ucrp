...
RegisterNetEvent('dg-identity:showRegisterIdentity')
AddEventHandler('dg-identity:showRegisterIdentity', function()
	if not isDead then
		EnableGui(true)
	end
end)
...
RegisterNetEvent('dg-identity:saveID')
AddEventHandler('dg-identity:saveID', function(data)
	myIdentifiers = data
end)
