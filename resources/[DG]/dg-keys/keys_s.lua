...
DGCore.RegisterServerCallback('dg-keys:checkOwner', function(source, cb, plate)
...
AddEventHandler('garage:giveKey', function(target, plate)
  ...
  local xPlayer = DGCore.GetPlayerFromId(targetSource)
  local ident = xPlayer.getIdentifier()
  local xPlayer2 = DGCore.GetPlayerFromId(source)
