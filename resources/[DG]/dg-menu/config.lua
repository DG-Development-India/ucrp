...
rootMenuConfig =  {
    {
        ...
        icon = "#globe-europe",
        enableMenu = function()
            isDead = exports["dg-ambulancejob"]:GetDeath()
            return not isDead
        end,
    ...
    --     enableMenu = function()
    --         isDead = exports["dg-ambulancejob"]:GetDeath()
    --         return (DGCore.GetPlayerData().job.name == 'mechanic' and not isDead)
    --     end,
    --     subMenus = {"general:usecarjack", "general:inspectvehicle", "general:repairhealthparts", "general:vehenginerepair", "general:vehbodyrepair", "general:propemotes"}
    -- },
    {
        id = "police-action",
        ...
        enableMenu = function()
            isDead = exports["dg-ambulancejob"]:GetDeath()
            return (DGCore.GetPlayerData().job.name == 'police' and not isDead)
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["dg-ambulancejob"]:GetDeath()
            return not isDead and DGCore.GetPlayerData().job.name == 'police'
        end
    },
    {
        id = "police-vehicle",
        ...
        enableMenu = function()
            isDead = exports["dg-ambulancejob"]:GetDeath()
            return (DGCore.GetPlayerData().job.name == 'police' and not isDead and IsPedInAnyVehicle(PlayerPedId(), false))
        end,
        ...
        enableMenu = function()
            ...
            if not isDead and not IsPlayerFreeAiming(PlayerId()) and not IsPedInAnyVehicle(PlayerPedId(), false) and not isHandcuffed and not isHandcuffedAndWalking then
                if DGCore.GetPlayerData().job.name == 'police' then
                     return true
                elseif exports["dg-inventory"]:hasEnoughOfItem("cuffs",1,false) then
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["dg-ambulancejob"]:GetDeath()
         return (not isDead and not isHandcuffed and not isHandcuffedAndWalking and (exports["dg-inventory"]:hasEnoughOfItem("cuffs",1,false) or DGCore.GetPlayerData().job.name == 'police'))
    ...
    },
    {
        ...
        enableMenu = function()
            isDead = exports["dg-ambulancejob"]:GetDeath()
            return (DGCore.GetPlayerData().job.name == 'ambulance' and not isDead)
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            downed = exports["dg-ambulancejob"]:GetDeath()
            return DGCore.GetPlayerData().job.name == 'police' and downed end
    },
    {
        id = "policeDeadB",
        displayName = "10-13B",
    ...
    },
    {
        ...
        enableMenu = function()
            downed = exports["dg-ambulancejob"]:GetDeath()
            return DGCore.GetPlayerData().job.name == 'ambulance' and downed end
    },
    {
        id = "emsDeadB",
        displayName = "10-14B",
    ...
    },
    {
        ...
        icon = "#uber-driver",
        functionName = "dg-uberdelivery:start",
        enableMenu = function()
            downed = exports["dg-ambulancejob"]:GetDeath()
            return DGCore.GetPlayerData().job.name == 'uberdriver' and not downed end
    },
    {
        id = "uberdriver",
        displayName = "End Delivery",
        icon = "#uber-driver2",
        functionName = "dg-uberdelivery:end",
        enableMenu = function()
            downed = exports["dg-ambulancejob"]:GetDeath()
            return DGCore.GetPlayerData().job.name == 'uberdriver' and not downed end
    },
...
newSubMenus = {
    ...
    ['general:keysgive'] = {
        ...
        functionName = "garageadd:giveKey"
    },
    ['general:apartgivekey'] = {
        title = "Give Key",
        icon = "#general-apart-givekey",
        functionName = "dg-housing:client:giveHouseKey"
    },
    ['general:apartremovekey'] = {
        title = "Remove Key",
        icon = "#general-apart-givekey",
        functionName = "dg-housing:client:removeHouseKey"
    },
    ['general:lockhouse'] = {
        title = "Lock/Unlock House",
        icon = "#general-apart-givekey",
        functionName = "dg-housing:client:lockHouse"
    },
    ['general:askfortrain'] = {
        title = "Request Train",
    ...
    --     title="Car Jack",
    --     icon="#expressions-weird2",
    --     functionName = "CarJackFunction"
    -- },
    -- ["mechanic:inspectvehicle"]  = {
    --     title="Inspect vehicle",
    --     icon="#expressions-weird2",
    --     functionName = "InspectVehicleFunction"
    -- },
    -- ["mechanic:repairhealthparts"]  = {
    --     title="Health part",
    --     icon="#expressions-weird2",
    --     functionName = "RepairVehicleHealthPart"
    -- },
    -- ["mechanic:vehenginerepair"]  = {
    --     title="Engine repair",
    --     icon="#expressions-weird2",
    --     functionName = "RepairVehicleEngine"
    -- },
    -- ["mechanic:vehbodyrepair"]  = {
    --     title="Body repair",
    --     icon="#expressions-weird2",
    --     functionName = "CarJackFunction"
    -- },
    ...
    --     title="Prop emotes",
    --     icon="#expressions-weird2",
    --     functionName = "CarryObjectsMainMenu"
    -- }
}
...
AddEventHandler('warrantsGui', function()
    ...
    --TriggerEvent('dg-mdt:hotKeyOpen')
    ExecuteCommand("mdt")
end)
