TokoVoipConfig = {
	...
	keySwitchChannels = Keys["Y"], -- Keybind used to switch the radio channels
...
AddEventHandler("onClientResourceStart", function(resource)
	if (resource == GetCurrentResourceName()) then	--	Initialize the script when this resource is started
		Citizen.CreateThread(function()
			TokoVoipConfig.plugin_data.localName = "Player"; -- Set the local name
		end);
		 -- Trigger this event whenever you want to start the voip
	end
end)
