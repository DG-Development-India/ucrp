...
--- Config ---
notWhitelistedMessage = "Please join our discord in order to play on the server. Discord: https://discord.gg/yrRQzB3dS3" -- Message displayed when they are not whitelist with the role
