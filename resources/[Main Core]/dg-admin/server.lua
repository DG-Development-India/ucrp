...
RegisterServerEvent('dg-admin:Cloak')
AddEventHandler('dg-admin:Cloak', function(src, toggle)
    TriggerClientEvent("dg-admin:Cloak", -1, src, toggle)
end)
...
RegisterServerEvent('dg-admin:RaveMode')
AddEventHandler('dg-admin:RaveMode', function(toggle)
    local source = source
    TriggerClientEvent('dg-admin:toggleRave', -1, toggle)
end)

RegisterServerEvent('dg-admin:AddPlayer')
AddEventHandler("dg-admin:AddPlayer", function()
    local licenses
    ...
    TriggerClientEvent("dg-admin:AddPlayer", -1, data )
    dg.Admin.AddAllPlayers()
end)
...
AddEventHandler('admin:bringPlayer', function(target)
    ...
    TriggerClientEvent('dg-admin:teleportUser', target, coords.x, coords.y, coords.z)
    TriggerClientEvent('DoLongHudText', source, 'You brought this player.')
end)

function dg.Admin.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("dg-admin:AddAllPlayers", source, data)

    end
end

function dg.Admin.AddPlayerS(self, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("dg-admin:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("dg-admin:RemoveRecent", -1, data)
end)
